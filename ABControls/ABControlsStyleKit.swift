...
//  ABControls
//
//  Created by Al Corbett on 8/16/18.
...
public class ABControlsStyleKit : NSObject {
    ...
    @objc dynamic public class func drawPotentiometerRadial(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 500, height: 500), resizing: ResizingBehavior = .aspectFit, ovalWidth: CGFloat = 31, percentComplete: CGFloat = 50) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func imageOfPotentiometerRadial(ovalWidth: CGFloat = 31, percentComplete: CGFloat = 50) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 500, height: 500), false, 0)
            ABControlsStyleKit.drawPotentiometerRadial(ovalWidth: ovalWidth, percentComplete: percentComplete)

        let imageOfPotentiometerRadial = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfPotentiometerRadial
    }
